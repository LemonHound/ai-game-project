...
test.describe('Site Navigation', () => {
  ...
  test('navigation links work correctly', async ({ page }) => {
    ...
    const homeLink = page
      .locator('nav a[href="/"], a:has-text("Home"), [data-testid="home-link"]')
      .first();
  ...
  test('URL parameters work correctly', async ({ page }) => {
    ...
    const chessElement = page.locator(
      '[data-game="chess"], .game[data-id="chess"], :has-text("chess"):has-text("Chess")'
    );
